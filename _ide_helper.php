 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function streamUpload($path, $fileName, $file, $overWrite = true)
        {
                        return \Illuminate\Filesystem\Filesystem::streamUpload($path, $fileName, $file, $overWrite);
        }
