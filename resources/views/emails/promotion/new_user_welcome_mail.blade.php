        ...
        <center>
            <div style="max-width: 665px;margin: 60px 0px;">
                ...
                <div style="background: url('{{ asset('/mail-assets/mail-body-background.png') }}');padding: 100px 0px">
                    <h2 style="padding: 0;margin: 0;color: #fff;font-size: 40px;font-weight: 900;margin-bottom: 18px;text-align: center">Welcome to WAM <br> {{ $name }}!</h2>
                ...
                <div style="background: #fff;color: #909FA8;text-align: center;padding: 30px;border-bottom: 1px solid #EDEFF0;">
                    <p style="text-align: center;margin-bottom: 30px;">Your account has been set up successfully. Click on the button below to <br> start your journey.</p>
                    <a style="text-decoration: none;background: #38B6FF;color: #fff;padding: 10px 20px;border-radius: 5px;font-weight: 600;" href="{{ url('/') }}">Go to WAM ACADEMY</a>
                </div>
                <div style="background: #fff;color: #909FA8;text-align: left;padding: 30px;border-radius: 0px 0px 5px 5px;">
                    ...
                    <p>All Rights Reserved | WAM Academy</p>
                </div>
            </div>
        </center>
    </div>
