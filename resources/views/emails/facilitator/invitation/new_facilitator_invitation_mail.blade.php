        ...
        <center>
            <div style="max-width: 665px;margin: 60px 0px;">
                ...
                <div style="background: #fff;color: #909FA8;text-align: center;padding: 30px;">
                    <p style="text-align: center;margin-bottom: 30px;line-height: 30px;">You have been invited to join WAM ACADEMY as a facilitator. You will be <br> able to provide impactful stories to students and measure their progress.</p>
                    <a style="text-decoration: none;background: #38B6FF;color: #fff;padding: 10px 20px;border-radius: 5px;font-weight: 600;" href="{{ url('/auth/registation?role=1&ins_id='.$institution_code.'&email='.$email) }}">Accept invitation</a>
                </div>
            </div>
        </center>
    </div>
