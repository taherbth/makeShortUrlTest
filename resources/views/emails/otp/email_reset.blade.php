        ...
        <center>
            <div style="max-width: 665px;margin: 60px 0px;">
                ...
                <div style="background: url('{{ asset('/mail-assets/mail-body-background.png') }}');padding: 100px 0px">
                    <h2 style="padding: 0;margin: 0;color: #fff;font-size: 40px;font-weight: 900;margin-bottom: 18px;text-align: center">Verify your <br> Email!</h2>
                    <p style="padding: 0;margin: 0;color: #fff;font-size: 20px;font-weight: 500;text-align: center">Verify your email address to get started.</p>
                </div>
