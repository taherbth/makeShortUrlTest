...
<script>
    ...
    export default {
        ...
        methods: {
            SendOtp: function (el){
                this.Step = 1
                axios.post('api/facilitator/email_reset_request').then(res => {
                    this.Step = 2
                }).catch(error => {
            ...
            CheckOtp: function (el){
                ...
                axios.post('api/facilitator/email_reset_otp_verify', data).then(res => {
                    this.Step = 3
                }).catch(error => {
                    this.ValidtaeForm(error)
                });
            ...
            ChangeEmailAddress: function (el){
                this.errors = {}
                let data = this.FilterForm(el.target, 'formdata')
                axios.post('api/facilitator/email_reset', data).then(res => {
