    ...
    <div class="page-wrapper">
        <div class="text-center">
            ...
            <div class="ins-img-wrapper">
                <img :src="User.profile_picture || '/assets/images/user-avatar.png'" class="rounded-circle mb-4" style="width:150px" id="image-preview">
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control" placeholder="Jeremie Goyette" :value="ProfileInfo.name" required />
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getProfile: function (){
                axios.get('api/authority/get_profile').then(res => {
            ...
            ChangeProfileInfo: function (el){
                ...
                axios.post('api/authority/edit_profile', data).then(res => {
