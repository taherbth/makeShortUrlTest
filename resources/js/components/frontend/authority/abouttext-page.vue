                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <label>Text</label>
                                    <ckeditor :editor="editor" v-model="ContactInfo.abouttext" :config="{}"></ckeditor>
                                    <textarea class="form-control d-none" name="abouttext" v-model="ContactInfo.abouttext" />
                                    <small class="form-text text-danger text-left" v-if="errors.abouttext"> {{ errors.abouttext[0] }} </small>
                                </div>
                            </td>
                        </tr>
                        <tr>
