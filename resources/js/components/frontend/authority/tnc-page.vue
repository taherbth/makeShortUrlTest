<template>
    <div class="page-wrapper">
        <div class="text-center" style="width: 100%" >
            <h3>WAM Academy Terms & Conditions</h3>
            <p class="text-secondary">You can change your Terms & Conditions page information from this section</p>


            <div style="margin-top:60px;">
                <form @submit.prevent="UpdateOrCreateContact">
                    <h5 class="text-left mb-3">Update About WAM Academy Terms & Conditions</h5>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <ckeditor :editor="editor" v-model="ContactInfo.tnc" :config="{}"></ckeditor>
                                    <textarea class="form-control d-none" name="tnc" v-model="ContactInfo.tnc" />
                                    <small class="form-text text-danger text-left" v-if="errors.tnc"> {{ errors.tnc[0] }} </small>
                                </div>
                            </td>
                        </tr>
                        <tr>
