<template>
    <div class="page-wrapper">
        <div class="text-center" style="width: 100%" >
            <h3>Feature</h3>
            <p class="text-secondary">You can publish your features from this section</p>
            ...
            <div style="margin-top:60px;">
                <div v-if="Step === 1">
                    <div class="space-between mb-3">
                        <h5> Feature List </h5>
                        <a href="javascript:void(0)" class="btn btn-primary-text" @click="AddBlog">Add Feature</a>
                    </div>
                        ...
                        <table class="table table-borderless r-table r-table-text-center">
                            ...
                            <tr v-if="blogList.data.length<1">
                                <td class="r-card-empty" colspan="3">
                                    ...
                                    <h6 class="font-weight-bold">No Feature to show</h6>
                                    <p class="text-secondary mb-0">We'll show Feature once you get started!</p>
                                </td>
                            </tr>
                ...
                <form @submit.prevent="SubmitForm" v-if="Step === 2">
                    <h5 class="text-left mb-3" v-text="BlogInfo.id>=1? 'Update Feature':'Create Feature'"></h5>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <label>Title</label>
                                    <input type="text" class="form-control" name="value" v-model="BlogInfo.value" />
...
export default {
    ...
    methods: {
        ...
        GetBlogList: function (page = 1){
            this.Step = 1
            axios.get('api/authority/feature?page=' + page).then(res => {
        ...
        GoToEdit: function (id){
            axios.get(`api/authority/feature/${id}`).then(res => {
                this.BlogInfo = {
                    'id': res.data.id,
        ...
        CreateBlog: function (el){
            ...
            axios.post('api/authority/feature', data).then(res => {
                this.ResetPage();
                this.$swal.fire({
                    icon: 'success',
        ...
        UpdateBlog: function (el){
            ...
            axios.post(`api/authority/feature/${this.BlogInfo.id}`, data).then(res => {
                this.ResetPage();
                this.$swal.fire({
                    icon: 'success',
                    text: res.data.message,
        ...
        DeleteBlog: function (id){
            this.$swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.post(`api/authority/feature/${id}`, {_method: "DELETE"}).then(res => {
                        this.GetBlogList();
