        ...
        <div class="container">
            ...
            <section class="wam-header-xl">
                ...
                <div class="part-2">
                    ...
                    <router-link to="/institution/watch" class="btn nav-item watch"> <font-awesome icon="play-circle" class="text-danger"/> Watch </router-link>
                    <router-link to="/institution/responses" class="btn nav-item response"> <font-awesome icon="bars" class="text-warning"/> Responses </router-link>
                    <router-link to="/institution/video/upload" class="btn nav-item uploads"> <metro-file-upload /> Uploads </router-link>
                    <router-link to="/institution/manage" class="btn nav-item manage"> <font-awesome icon="cog" style="color:#6C81EB"/> Manage </router-link>
                </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-section">
                            ...
                            <ul class="list-group profile-links" style="list-style:none">
                                <li class="list-items"><router-link to="/institution/profile#/profile" class="col-12">Personal Settings</router-link></li>
                ...
                <div class="col-9 sidebar-content-wrapper">
                    <div class="sidebar-top">
                        ...
                        <ul class="list-unstyled components">
                            ...
                            <li><router-link to="/institution/watch">Watch</router-link></li>
                            <li><router-link to="/institution/responses">Responses</router-link></li>
                            <li><router-link to="/institution/video/upload">Uploads</router-link></li>
                            <li><router-link to="/institution/manage">Manage</router-link></li>
                            <li><router-link to="/institution/profile#/profile">Profile Settings</router-link></li>
        ...
        methods:{
            ...
            getNotifications: function (){
                if (this.isNotificationOpen) {
                    ...
                    axios.get('/api/institution/get_all_notifications').then((res) => {
            ...
            SearchAllData: function (el){
                ...
                if(this.$route.query.topic && this.$route.query.topic != null && this.$route.query.topic != ""){
                    this.$router.push(`/institution/watch?query=${query}&topic=${this.$route.query.topic}`)
                }else{
                    this.$router.push(`/institution/watch?query=${query}`)
                }
            },
            SearchKeyPress: function (el){
                ...
                if(this.$route.query.topic && this.$route.query.topic != null && this.$route.query.topic != ""){
                    axios.get(`/api/institution/get_courses?query=${query}&topic=${this.$route.query.topic}`).then(res => {
                        this.searchData = res.data.data?res.data.data.slice(0, 8):[]
                    })
                }else{
                    axios.get(`/api/institution/get_courses?query=${query}`).then(res => {
                        this.searchData = res.data.data?res.data.data.slice(0, 8):[]
                    })
                }
            },
            getSearchQuery: function (id){
                this.overlayOff()
                this.$router.push(`/institution/watch/play/${id}`)
            },
            overlayOn: function (){
            ...
            LogOut: function (){
                axios.post('/api/institution/logout').then(success => {
                    this.LocalLogout()
                }).catch(error => {
            ...
            $(document).ready(function(){
                $(".search-submit-xl, .search-submit-md").click((el) => {
                    ...
                    if(self.$route.query.topic && self.$route.query.topic != null && self.$route.query.topic != ""){
                        self.$router.push(`/institution/watch?query=${query}&topic=${self.$route.query.topic}`)
                    }else{
                        self.$router.push(`/institution/watch?query=${query}`)
                    }
                })
            })
