        ...
        <div class="container">
            ...
            <section class="wam-header-xl">
                ...
                <div class="part-2">
                    ...
                    <router-link to="/authority/pricing" class="btn nav-item watch"> <font-awesome icon="tags" class="text-danger" style="transform: rotate(90deg);"/> Pricing </router-link>
                    <router-link to="/authority/institution" class="btn nav-item response"> <font-awesome icon="users" class="text-warning"/> Institution </router-link>
                    <router-link to="/authority/manage" class="btn nav-item manage"> <font-awesome icon="cog" style="color:#6C81EB"/> Manage </router-link>
                    <router-link to="/authority/frontend" class="btn nav-item manage"> <font-awesome icon="cog" style="color:#6C81EB"/> Frontend </router-link>
                    <router-link to="/authority/video/upload" class="btn nav-item uploads"> <metro-file-upload /> Uploads  </router-link>
                </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-section">
                            ...
                            <ul class="list-group profile-links" style="list-style:none">
                                <li class="list-items"><router-link to="/authority/profile#/profile" class="col-12">Personal Settings</router-link></li>
                ...
                <div class="col-9 sidebar-content-wrapper">
                    <div class="sidebar-top">
                        ...
                        <ul class="list-unstyled components">
                            ...
                            <li><router-link to="/authority/pricing">Pricing</router-link></li>
                            <li><router-link to="/authority/institution">Institution</router-link></li>
                            <li><router-link to="/authority/manage">Manage</router-link></li>
                            <li><router-link to="/authority/frontend">Frontend</router-link></li>
                            <li><router-link to="/authority/profile#/profile">Profile Settings</router-link></li>
        ...
        methods:{
            ...
            getNotifications: function (){
                if (this.isNotificationOpen) {
                    ...
                    axios.get('/api/authority/get_all_notifications').then((res) => {
            ...
            SearchAllData: function (el){
                ...
                if(this.$route.query.topic && this.$route.query.topic != null && this.$route.query.topic != ""){
                    this.$router.push(`/authority/watch?query=${query}&topic=${this.$route.query.topic}`)
                }else{
                    this.$router.push(`/authority/watch?query=${query}`)
                }
            },
            SearchKeyPress: function (el){
                ...
                if(this.$route.query.topic && this.$route.query.topic != null && this.$route.query.topic != ""){
                    axios.get(`/api/authority/get_courses?query=${query}&topic=${this.$route.query.topic}`).then(res => {
                        this.searchData = res.data.data?res.data.data.slice(0, 8):[]
                    })
                }else{
                    axios.get(`/api/authority/get_courses?query=${query}`).then(res => {
                        this.searchData = res.data.data?res.data.data.slice(0, 8):[]
                    })
                }
            },
            getSearchQuery: function (id){
                this.overlayOff()
                this.$router.push(`/authority/watch/play/${id}`)
            },
            overlayOn: function (){
            ...
            LogOut: function (){
                axios.post('/api/authority/logout').then(success => {
                    this.LocalLogout()
                }).catch(error => {
            ...
            $(document).ready(function(){
                $(".search-submit-xl, .search-submit-md").click((el) => {
                    ...
                    if(self.$route.query.topic && self.$route.query.topic != null && self.$route.query.topic != ""){
                        self.$router.push(`/authority/watch?query=${query}&topic=${self.$route.query.topic}`)
                    }else{
                        self.$router.push(`/authority/watch?query=${query}`)
                    }
                })
            })
