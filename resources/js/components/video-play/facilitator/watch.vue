        ...
        <Layout>
            ...
            <div class="row" v-if="videos.length">
                <div class="col-lg-7" v-if="videos[0]">
                    <LatestVideo :video_link="`/facilitator/watch/play/${videos[0].id}`" :thumbnail="videos[0].thumbnail || 'https://via.placeholder.com/720x360.jpg?text=Thumbnail+not+found'"
                ...
                <div class="col-lg-5 row padding-right-sm-none">
                    <div class="col-12" v-if="videos[1]">
                        <VerticalVideoItem :video_link="`/facilitator/watch/play/${videos[1].id}`" :thumbnail="videos[1].thumbnail || 'https://via.placeholder.com/230x180.jpg?text=Thumbnail+not+found'"
                    ...
                    <div class="col-12" v-if="videos[2]">
                        <VerticalVideoItem :video_link="`/facilitator/watch/play/${videos[2].id}`" :thumbnail="videos[2].thumbnail || 'https://via.placeholder.com/230x180.jpg?text=Thumbnail+not+found'"
                    ...
                    <div class="col-12" v-if="videos[3]">
                        <VerticalVideoItem :video_link="`/facilitator/watch/play/${videos[3].id}`" :thumbnail="videos[3].thumbnail || 'https://via.placeholder.com/230x180.jpg?text=Thumbnail+not+found'"
                ...
                <div class="display-contents" v-for="(video, index) in allVideos" :key="video.id">
                    ...
                    <div class="col-lg-3">
                        <HorizontalVideoItem :video_link="`/facilitator/watch/play/${video.id}`" :thumbnail="video.thumbnail || 'https://via.placeholder.com/230x180.jpg?text=Thumbnail+not+found'"
    ...
    export default {
        ...
        methods: {
            getVideos: function (page=null){
                ...
                if (page !== null && this.query !== "" && this.topic !== ""){this.$router.push(`/facilitator/watch?query=${this.query}&topic=${this.topic}&page=${this.page}`).catch(err => {})}
                axios.get(`/api/facilitator/get_courses?query=${this.query}&topic=${this.topic}&page=${this.page}`).then(response => {
            ...
            getTopics: function (){
                axios.get('/api/facilitator/get_topics').then(sueess => {
