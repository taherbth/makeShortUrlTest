<template>
    <div>        
        <Layout>
                    ...
                    <div class="tabs">
                        <div class="row">                
                            <div class="col-5 pr-0">
                                <a :class="['col-12', 'mb-0', 'btn', 'institution', tabActive==='institution'? 'active':'']" href="javascript:void(0)" @click="watch('institution')">
                                    Institution video
                                </a> 
                            </div>
                            <div class="col-5 pr-0">
                                <a :class="['col-12', 'mb-0', 'btn', 'demo', tabActive==='demo'? 'active':'']" href="javascript:void(0)" @click="watch('demo')">
                                    Demo video
                                </a> 
                            </div>
                        </div> 
            ...
            <topics-list :topics="topics" :tabActive="tabActive" />
            <div class="row" v-if="videos.length">
                <div class="col-lg-7" v-if="videos[0]">
                    <LatestVideo :video_link="`/watch/play/${videos[0].id}`" :thumbnail="videos[0].thumbnail || 'https://via.placeholder.com/720x360.jpg?text=Thumbnail+not+found'"
                ...
                <div class="col-lg-5 row padding-right-sm-none">
                    <div class="col-12" v-if="videos[1]">
                        <VerticalVideoItem :video_link="`/watch/play/${videos[1].id}`" :thumbnail="videos[1].thumbnail || 'https://via.placeholder.com/230x180.jpg?text=Thumbnail+not+found'"
                    ...
                    <div class="col-12" v-if="videos[2]">
                        <VerticalVideoItem :video_link="`/watch/play/${videos[2].id}`" :thumbnail="videos[2].thumbnail || 'https://via.placeholder.com/230x180.jpg?text=Thumbnail+not+found'"
                    ...
                    <div class="col-12" v-if="videos[3]">
                        <VerticalVideoItem :video_link="`/watch/play/${videos[3].id}`" :thumbnail="videos[3].thumbnail || 'https://via.placeholder.com/230x180.jpg?text=Thumbnail+not+found'"
                ...
                <div class="display-contents" v-for="(video, index) in allVideos" :key="video.id">
                    ...
                    <div class="col-lg-3">
                        <HorizontalVideoItem :video_link="`/watch/play/${video.id}`" :thumbnail="video.thumbnail || 'https://via.placeholder.com/230x180.jpg?text=Thumbnail+not+found'"
    ...
    export default {
        data() {
            return {
                ...
                tabActive : this.$route.query.tabActive || "institution",
            }
        },
        components: {
            Layout,
        ...
        methods: {
            getVideos: function (page=null){                
                ...
                if (page !== null && this.query !== "" && this.topic !== ""){this.$router.push(`/watch?query=${this.query}&topic=${this.topic}&page=${this.page}`).catch(err => {})}
                axios.get(`/api/student/get_courses?query=${this.query}&topic=${this.topic}&page=${this.page}`).then(response => {
            ...
            getTopics: function (){
                axios.get('/api/student/get_topics').then(sueess => {
            ...
            watch(type){
                if(type=='demo'){
                    ...
                    this.topic = "";
                    this.page = 1; 
                    this.tabActive = "institution";
                    this.showInstitutionVideos();
                }

            },
            showInstitutionVideos: function(){
                this.tabActive =  "institution";
                this.getVideos();
                this.getTopics();
            },
            showDemoVideos: function (){
                this.tabActive =  "demo";
                this.getDemoVideos();
                this.getDemoTopics();
            },
            getDemoVideos: function (page=null){
                this.page = page || this.page
                if (page !== null && this.query !== "" && this.topic !== ""){this.$router.push(`/watch?query=${this.query}&topic=${this.topic}&tabActive=${this.tabActive}&page=${this.page}`).catch(err => {})}
                axios.get(`/api/student/get_demo_courses?query=${this.query}&topic=${this.topic}&tabActive=${this.tabActive}&page=${this.page}`).then(response => {
                    this.paginationInfo = response.data
                    this.videos = response.data.data || []
                }).catch(error => {
                    this.ValidtaeForm(error)
            ...
            getDemoTopics: function (){
                axios.get('/api/student/get_demo_topics').then(sueess => {
                    this.topics = sueess.data
                })
            },
...
<style scoped>
    ...
    .tabs .institution.active{ background: #E1F4FF;color: #234153; }
    .tabs .institution.active svg{ color: #38B6FF !important; }
    .tabs .institution:hover svg{ color: #38B6FF; }

    .tabs .demo.active{ background: #DCF4E2;color: #234153; }

</style>
<style>
    .tabs .demo.active svg .svg-icon{ fill: #15B33F !important; }
    .tabs .demo:hover svg .svg-icon{ fill: #15B33F; }
</style>
