        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <form>
                    ...
                    <p class="text-sm text-neutral"><router-link :to="url" class="btn btn-border-primary">Edit Response</router-link> You can edit your responses until the facilitators rate them</p>
                </form>
            </div>
        </div>
