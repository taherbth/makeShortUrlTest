                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center mb-5">
                            ...
                            <p class="text-sm text-secondary">Your Rate has been submitted successfully. The institution can see your response and rate based on your answer.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            SubmitResponsesRating: function (el){
                ...
                axios.post('api/institution/post_institution_rate_responses', data).then(response => {
