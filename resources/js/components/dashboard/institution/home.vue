                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-5 status-message">
                                <div>
                                    ...
                                    <router-link to="/institution/video/upload" class="btn btn-danger">Upload Videos</router-link>
                                </div>
                            </div>
                            <div v-if="AdsInfo && AdsInfo.id" class="col-12 col-md-12 col-lg-7 status-media">
                                ...
                                <div class="overlay-contents">
                                    <router-link :to="`/institution/watch/play/${AdsInfo.id}`"><font-awesome size="5x" icon="play-circle" /></router-link>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="wrapper-body">
                        ...
                        <div v-if="latest_responses.length">
                            ...
                            <router-link v-if="latest_responses.length" to="/institution/responses" class="text-info" >See more responses <font-awesome icon="angle-right" class="text-info" /></router-link>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getInstitutionStatistics: function (){
                axios.get(`/api/institution/get_institution_statistics`).then(res => {
            ...
            getLatestResponses: function (){
                axios.get(`/api/institution/get_institution_latest_responses`).then(res => {
            ...
            getLastPublishedVideo: function (){
                axios.get(`/api/institution/get_institution_last_published_video`).then(res => {
            ...
            InitProgress: function (){
                ...
                $(document).ready(function() {
                    axios.get(`/api/institution/get_institution_progress`).then(res => {
