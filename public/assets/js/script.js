/**
 * password-show-hide text inputs
*/
$(document).on('click', '.toggle-password', function(el) {
    $(this).toggleClass("fa-eye fa-eye-slash");
    var input = $(el.target.getAttribute('toggle'));
    input.attr('type') === 'password' ? input.attr('type','text') : input.attr('type','password')
});

// this is for progress bar 
! function(t) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], t) : "object" == typeof exports && "object" == typeof module ? module.exports = t(require("jquery")) : t(jQuery) }(function(t, e) {
    "use strict";
    t.fn.percircle = function(e) {
        ...
        return this.each(function() {
            ...
            var s = t(this),
                n = "",
                d = function(t, e) { s.on("mouseover", function() { t.children("span").css("color", e) }), s.on("mouseleave", function() { t.children("span").attr("style", "") }) };
            ...
            if (i) {
                ...
                var m = o * i;
                setTimeout(function() { t(".bar", s).css({ "-webkit-transform": "rotate(" + m + "deg)", "-moz-transform": "rotate(" + m + "deg)", "-ms-transform": "rotate(" + m + "deg)", "-o-transform": "rotate(" + m + "deg)", transform: "rotate(" + m + "deg)" }) }, 0)
    ...
    var r = function(e, r, a) {
            function s() { if (c -= 1, c > 30 && e.addClass("gt50"), c < 30 && e.removeClass("gt50"), i(), c <= 0) return n(), void e.html("<span>" + l + "</span>") }
            ...
            function i() {
                ...
                var r = 6 * c;
                t(".bar", e).css({ "-webkit-transform": "rotate(" + r + "deg)", "-moz-transform": "rotate(" + r + "deg)", "-ms-transform": "rotate(" + r + "deg)", "-o-transform": "rotate(" + r + "deg)", transform: "rotate(" + r + "deg)" })
            }
        ...
        a = function(t) { return t < 10 ? "0" + t : t }
});
